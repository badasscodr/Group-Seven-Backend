...
CREATE TABLE job_postings (
    ...
    "company" VARCHAR(255),
    "location" VARCHAR(255),
    "jobType" job_type_enum NOT NULL,
...
CREATE TABLE messages (
    ...
    "messageType" message_type_enum DEFAULT 'direct',
    "referenceId" UUID,
    "createdAt" TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE visa_documents (
    ...
    "visaType" visa_type_enum NOT NULL,
...
CREATE TABLE visa_notifications (
    ...
    "notificationType" visa_notification_type NOT NULL,
