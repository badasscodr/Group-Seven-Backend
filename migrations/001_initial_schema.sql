-- =====================================================
-- GROUP SEVEN INITIATIVES - INITIAL DATABASE SCHEMA
-- =====================================================
...
GROUP BY sr.id, u.first_name, u.last_name, u.email;

-- =====================================================
-- SUCCESS MESSAGE
-- =====================================================

SELECT 'Database schema created successfully with snake_case naming convention!' as status;